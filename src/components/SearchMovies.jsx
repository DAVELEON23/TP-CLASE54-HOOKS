...
function SearchMovies(){
	...
	// Credenciales de API
	const apiKey = "34c78d61";// Intenta poner cualquier cosa antes para probar
	...
	useEffect(() =>{
		const fetchData = async () =>{
			try{
				...
				if(peliculas.Error){
					throw new Error("Network respose was no OK")
					
				}
				const swap = peliculas.Search;
				console.log("movies update",swap)
				setMovies(peliculas.Search); 
				console.log("movies old:",movies)
